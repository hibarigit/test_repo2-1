  ...
  return (
    <View style={styles.container}>
      ...
      <Canvas style={styles.canvas} shadows>
        ...
        <ambientLight intensity={0.3} />
  {/* スポットライトの位置を調整: Xを右に、Zを手前に動かして影を左寄りに */}
        <spotLight position={[8, 10, 8]} angle={0.15} penumbra={1} castShadow intensity={1.5} />
  {/* ポイントライトはそのままにするか、必要に応じて調整 */}
        <pointLight position={[-10, -10, -10]} castShadow intensity={1.2} />
  {/* ディレクショナルライトの位置を調整: Xを右に、Zを手前に動かして影を左寄りに */}
